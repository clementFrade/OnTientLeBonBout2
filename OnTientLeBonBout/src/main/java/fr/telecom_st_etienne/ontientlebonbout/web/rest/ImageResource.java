...
import fr.telecom_st_etienne.ontientlebonbout.repository.ImageRepository;
...
/**
 * REST controller for managing {@link fr.telecom_st_etienne.ontientlebonbout.domain.Image}.
 */
@RestController
@RequestMapping("/api")
