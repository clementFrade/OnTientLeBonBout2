...
import fr.telecom_st_etienne.ontientlebonbout.repository.QuestionRepository;
...
/**
 * REST controller for managing {@link fr.telecom_st_etienne.ontientlebonbout.domain.Question}.
 */
@RestController
@RequestMapping("/api")
